...
def find_intersecting_point_hough_lines(theta_sideline, rho_sideline, theta_baseline, rho_baseline):
	...
	intercept_sideline = rho_sideline * (np.sin(theta_sideline) + (np.cos(theta_sideline) / np.sin(theta_sideline)))
	...
	intercept_baseline = rho_baseline * (np.sin(theta_baseline) + (np.cos(theta_baseline) / np.sin(theta_baseline)))
